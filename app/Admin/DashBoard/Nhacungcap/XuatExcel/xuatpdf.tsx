...
export const exportToPDF = (data: NhaCungCap[]) => {
  ...
  doc.setFontSize(16);
  doc.text("Độc lập - Tự do - Hạnh phúc", doc.internal.pageSize.width / 2, 30, {
    align: "center",
  });
  ...
  const dateStr = `Ngày ${currentDate.getDate()} tháng ${
  ...
  doc.setFont("times", "bold");
  doc.setFontSize(20);
  doc.text("DANH SÁCH NHÀ CUNG CẤP", doc.internal.pageSize.width / 2, 60, {
    align: "center",
  });
