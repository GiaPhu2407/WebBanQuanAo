...
// import { ProductSizes } from './form/ProductFormGender';
...
//         <ProductSizes formData={formData} onSizeQuantityChange={(sizes: any[]) => onSizeChange(sizes.map(size => size.tenSize).join(','))} />//+
