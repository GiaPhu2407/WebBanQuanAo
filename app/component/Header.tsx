      ...
      const Menu = () => {
        ...
        return (
          <div>
            <div className="bg-white w-full h-20 shadow fixed z-10">
              <div className="flex items-center justify-center h-full">
                <div className="flex gap-10 content-center">
                  {/* <p className="text-lg font-semibold">GiaPhu</p> */}
                  <ul className="flex gap-10 content-center">
                    ...
                    <li
                      onMouseEnter={() => {
                        ...
                        setShowFemaleDropdown(false); // Hide female dropdown
                      }}
                    >
                      <span className="relative cursor-pointer group">
                        <FaMars className="inline mr-1 mb-[3px]" /> {/* Male icon */}
                        Nam
                    ...
                    <li
                      onMouseEnter={() => {
                        ...
                        setShowMaleDropdown(false); // Hide male dropdown
                      }}
                    >
                      <span className="relative cursor-pointer group">
            ...
            <div className="bg-black h-[2000px] w-full">ádasdasd</div>
          </div>
        );
      };
