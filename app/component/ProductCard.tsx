...
//       <a href={`/component/Category?id=${product.idsanpham}`} className="block">
...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    ...
    >
      {/* Animated border effect when hovered */}
      {/* <div
        className={`absolute bg-gradient-to-bl from-orange-600 to-orange-400 w-full h-full z-[-1] -top-2 -left-2 rounded-2xl ${
